    ...
    timeline: [
      {
        ...
        description:
          "Chandragupta rose from humble origins under the mentorship of the strategist Chanakya (Kautilya), whose Arthashastra is traditionally linked to his court.",
      },
      {
        year: "c. 322 BCE",
        event: "Founded the Maurya Empire",
        description:
          "Overthrew the unpopular Nanda dynasty of Magadha, founding the Maurya line and beginning the first pan-Indian imperial state.",
      },
      {
        year: "c. 305 BCE",
        event: "Treaty with Seleucus Nicator",
        description:
          "Victory over Alexander's successor in Asia secured the northwest frontier and brought war elephants and Hellenistic diplomatic ties to the young Maurya dynasty.",
      },
      {
        year: "c. 297 BCE",
        event: "Abdicated and later passed away",
        description:
          "Abdicated in favour of his son Bindusara, continuing the Maurya dynasty, and embraced Jain asceticism, reportedly ending his life at Shravanabelagola.",
      },
      {
        year: "c. 268 BCE",
        event: "Dynasty reaches its height under Ashoka",
        description:
          "His grandson Ashoka, inheriting the empire through Bindusara, would carry the Maurya dynasty to its greatest territorial extent.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Succeeded his father Chandragupta I, transforming a regional Gupta principality into a dominant North Indian power.",
      },
      {
        year: "c. 350 CE",
        event: "Major expansion recorded in inscriptions",
        description:
          "The Prayaga Prashasti on the Allahabad Pillar, composed by his court poet Harishena, lists the many kings he defeated or brought to tributary submission across northern, eastern, and southern India.",
      },
      {
        year: "c. 380 CE",
        event: "Passed away; Chandragupta II succeeded",
        description:
          "His son Chandragupta II inherited and expanded the Gupta Empire, carrying the dynasty into what is remembered as India's classical golden age.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Ascended the throne after a contested succession and rapidly rebuilt the Chalukya kingdom his family had founded in the western Deccan.",
      },
      {
        year: "c. 618 CE",
        event: "Defeated Harsha on the Narmada",
        description:
          "Halted the southward advance of the powerful North Indian emperor Harshavardhana, a victory recorded by the Chinese monk Xuanzang.",
      },
      {
        year: "c. 624 CE",
        event: "Installed the Eastern Chalukya branch",
        description:
          "Placed his brother Vishnuvardhana on a new Eastern Chalukya throne in the Andhra region, extending the dynasty's reach across the Deccan.",
      },
      {
        year: "642 CE",
        event: "Died during Pallava invasion of Vatapi",
        description:
          "His capital fell to a Pallava counter-attack under Narasimhavarman I; the Badami Chalukya dynasty would later be restored by his successors.",
      },
    ],
    achievements: [
  ...
  },
  {
    ...
    forts: [
      ...
      },
      {
        name: "Nagda",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/mewar/nagda.jpg",
        description:
    ...
    timeline: [
      {
        ...
        description:
          "Born a prince of the Guhila line who, after the killing of his father, was raised in hiding before reclaiming his ancestral homeland, according to Mewari tradition.",
      },
      {
        year: "c. 734",
        event: "Captured Chittorgarh",
        description:
          "Wrested Chittorgarh from local rulers and made it the seat of Guhila power, the founding act of the Mewar dynasty.",
      },
      {
        year: "c. 753",
        event: "Established Mewar's dominance",
        description:
          "Bardic accounts connect this period with resistance to Arab incursions advancing from Sindh into western India.",
      },
      {
        year: "c. 810",
        event: "Death of Bappa Rawal",
        description:
          "Became the foundational figure from whom later Guhila and Sisodia rulers of Mewar, including Rana Sanga and Maharana Pratap, traced their line.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Came to power and, over nearly three decades, turned a regional Tamil kingdom into the dominant power of South India and the Indian Ocean.",
      },
      {
        year: "c. 1000 CE",
        event: "Conquered the Cheras, Pandyas, and northern Sri Lanka",
        description:
          "Extended Chola authority to the Maldive islands, building one of the earliest large-scale navies in Indian history.",
      },
      {
        year: "1010 CE",
        event: "Consecrated Brihadisvara Temple",
        description:
          "Commissioned the towering temple at Thanjavur as both a religious and political statement of Chola dynastic power.",
      },
      {
        year: "1014 CE",
        event: "Passed away",
        description:
          "Succeeded by his son Rajendra I, who carried Chola naval campaigns as far as Southeast Asia, continuing the dynasty's imperial expansion.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Inherited the Chahamana throne of Ajmer as a boy and, on reaching adulthood, extended his authority over Delhi, recently absorbed by the dynasty.",
      },
      {
        year: "1191",
        event: "Victory in the First Battle of Tarain",
        description:
          "Defeated the Ghurid ruler Muhammad of Ghor, defending the Chahamana frontier against invasion from Central Asia.",
      },
      {
        year: "1192",
        event: "Defeated in the Second Battle of Tarain",
        description:
          "Muhammad of Ghor returned with a larger force; the Chahamana army was defeated and Prithviraj was captured, later accounts differing on the manner of his death.",
      },
      {
        year: "12th–13th c.",
        event: "Legacy shaped by the Prithviraj Raso",
        description:
          "His court poet Chand Bardai's epic, composed and expanded over later centuries, cemented his image in Rajput memory even as the Chahamana dynasty's power in Delhi ended.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Ruled Mewar from Chittorgarh as the Guhila dynasty's seat, at a time when the Delhi Sultanate under Alauddin Khalji was aggressively expanding.",
      },
      {
        year: "1303",
        event: "Siege of Chittorgarh",
        description:
          "Alauddin Khalji laid siege to the Mewar capital; after months of resistance, the fort fell to the Sultanate.",
      },
      {
        year: "1303",
        event: "Death during the defense of Chittorgarh",
        description:
          "The fall of Chittorgarh marked a major setback for the Guhila dynasty, which would take decades to recover its former standing in Mewar.",
      },
    ],
    achievements: [
  ...
  },
  {
    ...
    forts: [
      ...
      },
      {
        name: "Achalgarh",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/mewar/achalgarh.jpg",
        description:
    ...
    timeline: [
      {
        ...
        event: "Ascended the throne",
        description:
          "Inherited the Mewar throne as a Sisodia ruler and, over three-and-a-half decades, made it the most powerful Rajput kingdom of its era.",
      },
      {
        year: "c. 1437",
        event: "Victory at the Battle of Sarangpur",
        description:
          "Decisively defeated the combined forces of the Sultans of Malwa and Gujarat, a triumph he commemorated with the Vijay Stambha.",
      },
      {
        year: "1448",
        event: "Constructed Vijay Stambha",
        description:
          "Built the Tower of Victory at Chittorgarh to mark his triumph over the Malwa and Gujarat Sultanates.",
      },
      {
        year: "1458",
        event: "Completed Kumbhalgarh Fort",
        description:
          "Credited with constructing or restoring more than thirty forts across Mewar, most famously the vast hilltop fortress of Kumbhalgarh.",
      },
      {
        year: "1468",
        event: "Death of Maharana Kumbha",
        description:
          "Killed by his own son, Udai Singh I (Uda); the Sisodia line he had strengthened would continue through his descendants, including Rana Sanga.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Became emperor of the Tuluva dynasty and, over roughly two decades, brought the Vijayanagara Empire to the height of its power.",
      },
      {
        year: "1520",
        event: "Victory at Raichur",
        description:
          "Captured the strategic fortress of Raichur from the Bijapur Sultanate after a hard-fought campaign, extending Vijayanagara authority toward the eastern coast.",
      },
      {
        year: "1520s",
        event: "Patron of Hampi's golden age",
        description:
          "His court at Hampi became a renowned centre of literature, home to the eight celebrated poets known as the Ashtadiggajas.",
      },
      {
        year: "1529",
        event: "Passed away",
        description:
          "His death marked the end of the Tuluva dynasty's most celebrated reign, though Vijayanagara continued under his successors for decades afterward.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Took the Sisodia throne despite earlier battle injuries and went on to become the most powerful Rajput ruler of his generation.",
      },
      {
        year: "c. 1518–1519",
        event: "Defeated the Sultans of Malwa and Gujarat",
        description:
          "Extended Mewar's influence over a wide swath of Rajasthan and Malwa, assembling a large confederacy of Rajput chiefs under Sisodia leadership.",
      },
      {
        year: "1527",
        event: "Battle of Khanwa against Babur",
        description:
          "Led the Rajput confederacy against the newly arrived Mughal power; despite a numerical advantage, Babur's artillery and tactics prevailed, and Sanga was severely wounded.",
      },
      {
        year: "1528",
        event: "Passed away",
        description:
          "His death left the Sisodia dynasty of Mewar to carry forward Rajput resistance under his descendants, including his grandson Maharana Pratap.",
      },
    ],
    achievements: [
  ...
  },
  {
    ...
    forts: [
      ...
      },
      {
        name: "Gogunda",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/mewar/gogunda.jpg",
        description:
      ...
      },
      {
        name: "Udaipur",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/mewar/udaipur.jpg",
        description:
    ...
    timeline: [
      {
        ...
        description:
          "Survived an assassination attempt as an infant, saved according to tradition by his nursemaid Panna Dhai, before eventually taking the Sisodia throne.",
      },
      {
        year: "1540",
        event: "Became ruler of Mewar",
        description:
          "Took the throne of Mewar as growing Mughal expansion under Akbar placed increasing pressure on the Sisodia dynasty.",
      },
      {
        year: "1559",
        event: "Founded Udaipur",
        description:
          "Founded a new city on the shores of Lake Pichola, which would become Mewar's capital after the fall of Chittorgarh.",
      },
      {
        year: "1567–1568",
        event: "Mughal siege of Chittorgarh",
        description:
          "Withdrew to the hills rather than making a last stand, a decision that preserved the Sisodia line to fight another day.",
      },
      {
        year: "1572",
        event: "Death at Gogunda",
        description:
          "His son Maharana Pratap succeeded him, carrying on the Sisodia dynasty's resistance to Mughal authority.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Born into the Sisodia dynasty of Mewar, son of Maharana Udai Singh II, founder of Udaipur.",
      },
      {
        year: "1572",
        event: "Ascended the throne of Mewar",
        description:
          "Became the thirteenth Sisodia ruler of Mewar, inheriting a kingdom already under severe pressure from Akbar's Mughal Empire.",
      },
      {
        year: "1576",
        event: "Battle of Haldighati",
        description:
          "Met a large Mughal force led by Man Singh of Amber; though the battle was not a decisive Mughal victory, Pratap was forced to retreat into the Aravalli hills.",
      },
      {
        year: "1576–1585",
        event: "Guerrilla campaign in the Aravallis",
        description:
          "Waged a sustained resistance, aided famously by his horse Chetak, gradually reclaiming much of Mewar's territory, including his capital at Chavand.",
      },
      {
        year: "1597",
        event: "Passed away at Chavand",
        description:
          "Died having never formally submitted to Mughal authority, passing the Sisodia throne on with Mewar's independence intact.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Born into the Bhonsle family and, from his teenage years, began seizing hill forts from the declining Bijapur Sultanate, laying the foundation of the Maratha dynasty.",
      },
      {
        year: "1645",
        event: "Captured Torna Fort",
        description:
          "An early conquest that marked the beginning of an independent Maratha state built around a network of Sahyadri hill forts.",
      },
      {
        year: "1659",
        event: "Defeated Afzal Khan",
        description:
          "Outmanoeuvred and killed the Bijapuri general in single combat, a turning point that established Shivaji as a major regional power.",
      },
      {
        year: "1674",
        event: "Coronation at Raigad",
        description:
          "Formally crowned Chhatrapati, founding the Bhonsle royal dynasty and giving institutional form to the Maratha kingdom.",
      },
      {
        year: "1680",
        event: "Passed away at Raigad",
        description:
          "Succeeded by his son Sambhaji, continuing the Bhonsle dynasty's pursuit of swarajya.",
      },
    ],
    achievements: [
  ...
  },
  {
    ...
    forts: [
      ...
      },
      {
        name: "Vishalgad",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/maratha/vishalgargh.jpg",
        description:
    ...
    timeline: [
      {
        ...
        description:
          "Born into the Bhonsle dynasty as heir to the Maratha kingdom his father had founded.",
      },
      {
        year: "1681",
        event: "Became Chhatrapati",
        description:
          "Succeeded Shivaji as Chhatrapati just as the Mughal emperor Aurangzeb personally moved his court south to crush the Marathas.",
      },
      {
        year: "1681–1689",
        event: "Sustained defensive war across the Deccan",
        description:
          "Defended Maratha forts and territory against a far larger Mughal army while also facing the Portuguese, the Siddis of Janjira, and Mysore.",
      },
      {
        year: "1689",
        event: "Martyrdom at Tulapur",
        description:
          "Captured near Sangameshwar and executed on Aurangzeb's orders after refusing to convert or betray Maratha forts; his death hardened rather than broke the Bhonsle dynasty's resistance.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Made supreme military commander of the Ahom kingdom, founded centuries earlier by the Tai-Ahom leader Sukaphaa, as Mughal forces pressed into Assam.",
      },
      {
        year: "1667–1671",
        event: "Recaptured Guwahati",
        description:
          "Led a determined campaign to retake territory seized by Mughal forces under the Bengal governor.",
      },
      {
        year: "1671",
        event: "Victory at Saraighat",
        description:
          "Halted a large Mughal counter-offensive on the Brahmaputra using a fleet of light Ahom boats, the last major Mughal attempt to conquer Assam.",
      },
      {
        year: "1672",
        event: "Passed away shortly after the war",
        description:
          "Died having secured the independence of the Ahom kingdom, which continued under Sukaphaa's dynasty for over a century more.",
      },
    ],
    achievements: [
    ...
    forts: [
      {
        name: "Shaniwar Wada",
        image:
          "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/forts/maratha/shaniwarwada.jpg",
        description:
    ...
    timeline: [
      {
        ...
        description:
          "Appointed chief minister of the Maratha Empire, founded by Shivaji's Bhonsle dynasty, at just twenty years old, beginning the rise of the Bhat Peshwa line.",
      },
      {
        year: "1728",
        event: "Victory at Palkhed",
        description:
          "Defeated the Nizam of Hyderabad using rapid cavalry manoeuvres, part of a career of more than forty engagements without a major defeat.",
      },
      {
        year: "1737",
        event: "Raid to the outskirts of Delhi",
        description:
          "Led a daring campaign that reached the Mughal capital itself, humbling the court and extending Maratha influence deep into North India.",
      },
      {
        year: "1740",
        event: "Passed away on campaign",
        description:
          "Died still undefeated in the field; the Peshwa office he had elevated continued under his descendants as the effective head of the Maratha confederacy.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Married into the Holkar family as a child, later taking direct control of the state after the deaths of her husband, father-in-law Malharrao Holkar, and son.",
      },
      {
        year: "1767",
        event: "Became ruler of the Holkar Kingdom",
        description:
          "Took charge of the Holkar dynasty's territory with the support of the Maratha court, ruling from Maheshwar rather than the traditional capital of Indore.",
      },
      {
        year: "1780s",
        event: "Restored major temples across India",
        description:
          "Used state resources to fund temple building, dharamshalas, wells, and roads from Kashi Vishwanath and Somnath to Ayodhya, Dwarka, and Rameswaram.",
      },
      {
        year: "1795",
        event: "Passed away at Maheshwar",
        description:
          "Left behind a Holkar state renowned for just governance and religious patronage that outlasted her own reign.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Took charge of his family's Sikh misl as a boy, the foundation from which he would later unify Punjab's fractious misls.",
      },
      {
        year: "1799",
        event: "Captured Lahore",
        description:
          "Used the city as the base from which he unified the Sikh misls of Punjab into a single kingdom.",
      },
      {
        year: "1801",
        event: "Proclaimed Maharaja of Punjab",
        description:
          "Formally founded the Sikh Empire, drawing Hindu, Muslim, Sikh, and European officials into a notably plural court and administration.",
      },
      {
        year: "1809",
        event: "Treaty of Amritsar",
        description:
          "Fixed the Sutlej as a boundary with the British East India Company, preserving peace during his lifetime.",
      },
      {
        year: "1813",
        event: "Captured Attock",
        description:
          "Expanded the Sikh Empire toward Kashmir and Peshawar as part of decades of territorial growth.",
      },
      {
        year: "1839",
        event: "Passed away in Lahore",
        description:
          "The kingdom he built was annexed by the British a decade later, after succession struggles weakened the dynasty he had founded.",
      },
    ],
    achievements: [
    ...
    timeline: [
      {
        ...
        description:
          "Married into the Newalkar dynasty of Jhansi, having been trained from childhood in horsemanship, swordsmanship, and self-defence.",
      },
      {
        year: "1853",
        event: "Husband's death and British annexation",
        description:
          "When Gangadhar Rao died leaving an adopted heir, the British East India Company invoked the Doctrine of Lapse to annex Jhansi, a decision Lakshmibai resisted.",
      },
      {
        year: "1857",
        event: "Revolt of 1857 begins",
        description:
          "Took direct command of Jhansi's defence as the uprising against British rule reached the state.",
      },
      {
        year: "1858",
        event: "Martyrdom at Gwalior",
        description:
          "Escaped the besieged city with her son after Hugh Rose's forces captured it, and was killed in action near Gwalior fighting alongside other rebel leaders.",
      },
    ],
    achievements: [

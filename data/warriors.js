...
window.EB_DATA.warriors = [
  ...
  "died": "c. 810",
  "biography": "Bappa Rawal is regarded as the founder of the Guhila dynasty's rule over Mewar. Historical traditions credit him with capturing Chittorgarh and consolidating Rajput authority in the region. He is also associated with resistance against Arab incursions into northwestern India.",
  "kingdomDescription": "Mewar emerged as one of the oldest and most resilient Rajput kingdoms, renowned for its warrior traditions, hill forts and commitment to sovereignty.",
  "campaigns": [
    "Capture of Chittorgarh",
    "Expansion of Mewar",
    "Resistance against Arab invasions"
  ],
  "battles": [
    {
  ...
  "achievements": [
    "Founder of Mewar's royal legacy",
    "Established Rajput rule in Chittorgarh",
    "Associated with resistance against Arab invasions"
  ],
  "legacy": "Bappa Rawal is remembered as the founding hero of Mewar and one of the earliest Rajput rulers to establish a lasting kingdom.",
  "references": [
    "Eklinga Mahatmya",
    "Guhila inscriptions",
  ...
  "biography": "Rawal Ratan Singh ruled Mewar during the siege of Chittorgarh by Alauddin Khalji in 1303. Though historical accounts differ on several details, he is traditionally remembered for defending the kingdom until the fall of the fort.",
  "kingdomDescription": "Chittorgarh was the heart of Mewar and one of the strongest Rajput fortresses in medieval India.",
  "campaigns": [
    "Defense of Chittorgarh"
  ],
  "battles": [
    {
  ...
  "achievements": [
    "Defended Chittorgarh against invasion",
    "Remembered for Rajput valor"
  ],
  "legacy": "Rawal Ratan Singh symbolizes the courage and sacrifice associated with the defense of Chittorgarh.",
  "references": [
    "Amir Khusrau",
    "Rajput chronicles",
  ...
  "biography": "Maharana Kumbha transformed Mewar into one of the strongest kingdoms of medieval India. He constructed Kumbhalgarh Fort, commissioned the Vijay Stambha and successfully defended Mewar against repeated invasions.",
  "kingdomDescription": "Under Maharana Kumbha, Mewar reached unprecedented military and cultural prominence.",
  "campaigns": [
    "Wars against Malwa Sultanate",
    "Wars against Gujarat Sultanate",
    "Expansion of Mewar"
  ],
  "battles": [
    {
  ...
  "achievements": [
    "Built Kumbhalgarh Fort",
    "Constructed Vijay Stambha",
    "Defeated Malwa Sultanate"
  ],
  "legacy": "Maharana Kumbha is remembered as one of Mewar's greatest rulers and among medieval India's finest military leaders and patrons of architecture.",
  "references": [
  ...
  "biography": "Maharana Udai Singh II succeeded the throne of Mewar after surviving assassination attempts during his childhood. Following the Mughal siege of Chittorgarh, he established the city of Udaipur, ensuring the survival of the Sisodia kingdom.",
  "kingdomDescription": "During Udai Singh's reign, Mewar shifted its political center from Chittorgarh to the newly founded city of Udaipur.",
  "campaigns": [
    "Defense of Mewar",
    "Foundation of Udaipur",
    "Reorganization of Sisodia administration"
  ],
  "battles": [
    {
  ...
  "achievements": [
    "Founded Udaipur",
    "Preserved the Sisodia dynasty",
    "Father of Maharana Pratap"
  ],
  "legacy": "Maharana Udai Singh II ensured the continuity of Mewar through one of its most difficult periods and laid the foundation for Maharana Pratap's later resistance.",
  "references": [
    "Mewar chronicles",
    "Akbarnama",
  ...
  "biography": "Ahilyabai Holkar became ruler after the deaths of her husband and son. She transformed Maheshwar into a prosperous capital, promoted trade, ensured justice and sponsored the restoration of temples including Kashi Vishwanath and Somnath.",
  "kingdomDescription": "The Holkar Kingdom was one of the leading Maratha states, known for efficient governance and economic prosperity.",
  "campaigns": [
    "Administration of Malwa",
    "Defense of Holkar territories",
  ...
  "achievements": [
    "Model administrator",
    "Patron of temples and education",
    "Promoted trade and infrastructure"
  ],
  "legacy": "Ahilyabai Holkar is remembered as one of India's greatest rulers, admired for justice, compassion and architectural patronage.",
  "references": [

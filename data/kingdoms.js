// Auto-generated from kingdoms.json so pages work even when opened directly (file://) without a local server.
window.EB_DATA = window.EB_DATA || {};
window.EB_DATA.kingdoms = [
  {
    id: "maurya",
    name: "Maurya Empire",
    capital: "Pataliputra",
    ...
    description:
      "One of ancient India's largest empires, spanning much of the subcontinent under Chandragupta and Ashoka.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Chandragupta Maurya overthrew the Nanda dynasty of Magadha with the counsel of Chanakya, founding the Maurya dynasty and the first pan-Indian imperial state.",
      },
      {
        year: "c. 305 BCE",
        event: "Treaty with Seleucus Nicator",
        description:
          "Victory over Alexander's successor secured the northwest frontier and opened diplomatic ties to the Hellenistic world.",
      },
      {
        year: "c. 297 BCE",
        event: "Bindusara succeeds Chandragupta",
        description:
          "Chandragupta abdicated in favour of his son, continuing the Maurya dynasty's rule from Pataliputra.",
      },
      {
        year: "c. 268 BCE",
        event: "Ashoka's reign begins",
        description:
          "Chandragupta's grandson brought the Maurya dynasty to its greatest territorial extent before turning to the promotion of dhamma after the Kalinga war.",
      },
      {
        year: "185 BCE",
        event: "Maurya rule ends",
        description:
          "The dynasty's decline closed the first great chapter of pan-Indian imperial statecraft, though its administrative model influenced Indian statecraft for centuries.",
      },
    ],
    achievements: [
      "First pan-Indian imperial administration",
      "Ashokan edicts and the spread of dhamma",
      "Diplomatic ties with the Hellenistic world",
      "Governance principles recorded in the Arthashastra",
    ],
    legacy:
  ...
  },
  {
    ...
    description:
      "A classical empire associated with Sanskrit literature, science, and a flowering of temple culture.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Founded the Gupta dynasty from a Magadhan base, laying the groundwork for a classical age of Indian civilisation.",
      },
      {
        year: "c. 335 CE",
        event: "Samudragupta's expansion",
        description:
          "Samudragupta succeeded his father and, through conquest and tributary alliances recorded on the Allahabad Pillar, extended Gupta power across most of North India.",
      },
      {
        year: "c. 380 CE",
        event: "Chandragupta II succeeds",
        description:
          "Samudragupta's son extended the dynasty's rule further and is credited with presiding over the Gupta age's cultural high point, home to Kalidasa and Aryabhata.",
      },
      {
        year: "c. 550 CE",
        event: "Imperial Gupta power fades",
        description:
          "Later Gupta rulers were unable to maintain the dynasty's unity, ending the classical age their predecessors had built.",
      },
    ],
    achievements: [
      "Classical Sanskrit literature under Kalidasa and others",
      "Scientific and mathematical advances, including the work of Aryabhata",
      "Stable, high-purity gold coinage",
      "Extensive temple and cave-shrine patronage",
    ],
    legacy:
      "Later generations looked back to the Guptas as a golden age of learning and kingship, a benchmark of classical Indian civilisation whose literary and scientific achievements were remembered for centuries afterward.",
    references: [
    ...
    mapImage:
      "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/maps/gupta/map.png",
  },
  {
    id: "chalukya",
    ...
    description:
      "A Deccan imperial house famed for checking northern expansion and pioneering temple architecture in stone.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Founded the Chalukya dynasty of Badami, making Vatapi its royal centre and beginning the family's Deccan temple-building tradition.",
      },
      {
        year: "c. 610 CE",
        event: "Pulakeshin II's reign",
        description:
          "Brought the dynasty to its military peak, checking Harsha's southward advance at the Narmada and contesting supremacy with the Pallavas.",
      },
      {
        year: "c. 624 CE",
        event: "Eastern Chalukya branch founded",
        description:
          "Pulakeshin II installed his brother Vishnuvardhana as ruler of a new Chalukya line in the Andhra region, extending the dynasty's reach.",
      },
      {
        year: "642 CE",
        event: "Vatapi falls to the Pallavas",
        description:
          "A Pallava counter-invasion under Narasimhavarman I overran the Badami Chalukya capital, and Pulakeshin II is believed to have died defending it.",
      },
      {
        year: "753 CE",
        event: "Chalukya of Badami overthrown by the Rashtrakutas",
        description:
          "The restored Badami Chalukya dynasty was finally supplanted, closing out over two centuries of Chalukya rule in the western Deccan.",
      },
    ],
    achievements: [
      "Established a distinct Deccan imperial identity",
      "Pioneered early rock-cut and structural temple architecture",
      "Victory over Harshavardhana at the Narmada",
      "Founded the Eastern Chalukya line in Andhra",
    ],
    legacy:
  ...
  },
  {
    ...
    description:
      "A South Indian maritime empire celebrated for temple architecture, trade, and naval power.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Founded the Later Chola dynasty by seizing the city that would become the empire's heartland in the Kaveri delta.",
      },
      {
        year: "985 CE",
        event: "Raja Raja Chola I ascends",
        description:
          "Turned a regional Tamil kingdom into the dominant naval and military power of South India and the Indian Ocean.",
      },
      {
        year: "1010 CE",
        event: "Brihadisvara Temple consecrated",
        description:
          "Raja Raja I's temple at Thanjavur stood as a monument to Chola dynastic and religious power.",
      },
      {
        year: "1014 CE",
        event: "Rajendra I succeeds",
        description:
          "Raja Raja's son carried Chola naval campaigns across the Bay of Bengal to Sri Lanka and the Srivijaya kingdom of Southeast Asia.",
      },
      {
        year: "1279",
        event: "Later Chola power ends",
        description:
          "Chola rule closed after more than four centuries, leaving behind temple architecture and administrative traditions regarded as a high watermark of Tamil statecraft.",
      },
    ],
    achievements: [
      "The Brihadisvara Temple at Thanjavur, a UNESCO World Heritage Site",
      "Extensive Indian Ocean naval reach, including campaigns to Southeast Asia",
      "Sophisticated village-level administration documented in temple inscriptions",
      "Patronage of Chola bronze sculpture, among the finest in Indian art",
    ],
    legacy:
  ...
  {
    id: "chauhan",
    name: "Chauhan Kingdom",
    capital: "Ajmer / Delhi",
    dynasty: "Chahamana (Chauhan)",
    period: "7th century – 1192",
    founded: "7th century",
    region: "Rajasthan and the Delhi region",
    description:
      "A major Rajput power of Ajmer and Delhi, ending with Prithviraj Chauhan's fall at Tarain.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "The Chahamanas (Chauhans) rose to prominence around Ajmer in present-day Rajasthan.",
      },
      {
        year: "12th century",
        event: "Chauhan power peaks at Ajmer and Delhi",
        description:
          "Under Prithviraj Chauhan (Prithviraj III) the dynasty controlled both Ajmer and Delhi, positioning it at the frontier facing invasions from Central Asia.",
      },
      {
        year: "1191",
        event: "First Battle of Tarain",
        description:
          "Prithviraj Chauhan defeated the Ghurid ruler Muhammad of Ghor, defending the dynasty's northern frontier.",
      },
      {
        year: "1192",
        event: "Second Battle of Tarain",
        description:
          "Muhammad of Ghor returned with a larger force and defeated the Chahamana army, a decisive turning point that opened the way for the Delhi Sultanate.",
      },
    ],
    achievements: [
      "Rajput control of both Delhi and Ajmer under one dynasty",
      "Victory at the First Battle of Tarain, 1191",
      "Enduring place in North Indian historical and literary memory",
      "Subject of the epic Prithviraj Raso",
    ],
    legacy:
  ...
  },
  {
    ...
    dynasty: "Sangama / Tuluva",
    period: "1336 – 1646",
    founded: "1336 CE",
    region: "Southern Deccan and the peninsula",
    description:
      "The great southern empire whose capital at Hampi became one of the most magnificent cities of its age.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Brothers Harihara and Bukka of the Sangama dynasty founded Vijayanagara as a bulwark against Sultanate expansion into the south.",
      },
      {
        year: "1485",
        event: "Saluva dynasty takes power",
        description:
          "A change of ruling house preceded the rise of the Tuluva dynasty that would bring the empire to its zenith.",
      },
      {
        year: "1509",
        event: "Krishnadevaraya crowned",
        description:
          "The Tuluva emperor brought Vijayanagara to a height of wealth, military success, and literary patronage, with Hampi becoming one of the richest cities in the world.",
      },
      {
        year: "1565",
        event: "Battle of Talikota; capital sacked",
        description:
          "A coalition of Deccan Sultanates defeated Vijayanagara and sacked Hampi, breaking the empire's imperial power.",
      },
      {
        year: "1646",
        event: "Aravidu dynasty's rule ends",
        description:
          "The last ruling Vijayanagara line lost its remaining territory, closing over three centuries of the empire's history.",
      },
    ],
    achievements: [
      "Hampi's urban, temple, and irrigation landscape",
      "Unification of the southern peninsula into a single imperial state",
      "Court literature flourishing in Telugu, Kannada, and Sanskrit",
      "Extensive trade links across the Indian Ocean world",
    ],
    legacy:
  ...
  },
  {
    ...
    dynasty: "Sisodia",
    period: "8th – 20th Century",
    founded: "8th century",
    region: "Southern Rajasthan",
    description:
      "One of the oldest and most respected Rajput kingdoms, known for its forts, lakes, and unbroken spirit of independence.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Bappa Rawal captured Chittorgarh and founded the Guhila line from which all later Mewar rulers, including the Sisodia branch, traced their descent.",
      },
      {
        year: "1303",
        event: "Fall of Chittorgarh under Rawal Ratan Singh",
        description:
          "Alauddin Khalji's siege overran the Guhila capital, a major setback the dynasty took decades to recover from.",
      },
      {
        year: "1433",
        event: "Maharana Kumbha's reign begins",
        description:
          "The Sisodia ruler made Mewar the most powerful Rajput kingdom of its era, building Kumbhalgarh and the Vijay Stambha.",
      },
      {
        year: "1509",
        event: "Rana Sanga's reign begins",
        description:
          "United rival Rajput clans into a confederacy and led the largest coordinated Rajput resistance to early Mughal expansion at Khanwa.",
      },
      {
        year: "1559",
        event: "Udai Singh II founds Udaipur",
        description:
          "Shifted Mewar's capital to a new lakeside city, preserving the Sisodia dynasty after the fall of Chittorgarh to Akbar.",
      },
      {
        year: "1572",
        event: "Maharana Pratap ascends",
        description:
          "Refused to submit to Mughal authority, waging decades of resistance from the Aravalli hills after the Battle of Haldighati.",
      },
    ],
    achievements: [
      "Hill-fort architecture, including Chittorgarh and Kumbhalgarh",
      "The longest sustained Rajput resistance to imperial domination",
      "An unbroken Sisodia royal tradition surviving multiple sieges",
      "Foundation of Udaipur as a new capital after Chittorgarh's fall",
    ],
    legacy:
  ...
  },
  {
    id: "ahom",
    name: "Ahom Kingdom",
    capital: "Garhgaon / Rangpur",
    dynasty: "Ahom",
    period: "1228 – 1826",
    founded: "1228 CE",
    region: "Brahmaputra valley (Assam)",
    description:
      "A long-lived kingdom of Assam that defended the northeast through adaptive warfare and a distinct administrative system.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "The Tai-Ahom leader established a dynasty in the Brahmaputra valley that would rule for nearly six centuries.",
      },
      {
        year: "1667",
        event: "Mughal forces seize Guwahati",
        description:
          "Renewed Mughal pressure on the kingdom's western frontier led to the appointment of Lachit Borphukan as supreme military commander.",
      },
      {
        year: "1671",
        event: "Battle of Saraighat",
        description:
          "Lachit Borphukan's riverine campaign halted a major Mughal counter-offensive, securing Assam's independence for another century.",
      },
      {
        year: "1826",
        event: "Ahom power ends after the Treaty of Yandabo era",
        description:
          "The dynasty founded by Sukaphaa gave way to British colonial control, closing nearly six centuries of Ahom rule.",
      },
    ],
    achievements: [
      "Nearly six centuries of continuous independence in Assam",
      "The distinctive paik administrative and labour system",
      "Decisive victory over Mughal forces at Saraighat, 1671",
      "Preservation of a distinct Assamese cultural and political identity",
    ],
    legacy:
  ...
  },
  {
    ...
    name: "Maratha Empire",
    capital: "Raigad / Pune",
    dynasty: "Bhonsle / Peshwa",
    period: "1674 – 1818",
    founded: "1674 CE",
    region: "Deccan, then much of India",
    description:
      "A Deccan-based empire that grew into a major power, built on swarajya and innovative military tactics.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "The young Bhonsle chief began building the nucleus of an independent Maratha state around a network of hill forts.",
      },
      {
        year: "1674",
        event: "Coronation of Shivaji Maharaj",
        description:
          "Formally crowned Chhatrapati at Raigad, founding the Bhonsle dynasty and giving institutional form to Maratha swarajya.",
      },
      {
        year: "1681",
        event: "Sambhaji Maharaj becomes Chhatrapati",
        description:
          "Succeeded his father and sustained an eight-year defensive war against Aurangzeb's full Mughal army.",
      },
      {
        year: "1720",
        event: "Bajirao I becomes Peshwa",
        description:
          "The Bhat Peshwa line rose to prominence, with Bajirao's rapid cavalry campaigns extending Maratha power to the outskirts of Delhi.",
      },
      {
        year: "1761",
        event: "Third Battle of Panipat",
        description:
          "A major defeat checked the confederacy's northward expansion, though Maratha power continued under regional chieftains for decades more.",
      },
      {
        year: "1818",
        event: "Maratha Empire dismantled by the British",
        description:
          "The confederate structure built by the Bhonsles and Peshwas was finally broken up after the Anglo-Maratha Wars.",
      },
    ],
    achievements: [
      "Swarajya established as a lasting political ideal",
      "A distinctive combination of fort defence and guerrilla warfare",
      "18th-century expansion across most of the Indian subcontinent",
      "A durable confederate structure sustaining power across generations of leaders",
    ],
    legacy:
  ...
  },
  {
    ...
    description:
      "A powerful Punjabi empire founded by Maharaja Ranjit Singh, known for military modernization and inclusive rule.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Used the city as a base to begin unifying Punjab's fractious Sikh misls under Sukerchakia leadership.",
      },
      {
        year: "1801",
        event: "Ranjit Singh proclaimed Maharaja",
        description:
          "Formally founded the Sikh Empire, building a modern army and a religiously plural administration.",
      },
      {
        year: "1809",
        event: "Treaty of Amritsar",
        description:
          "Fixed the Sutlej as a boundary with the British East India Company, securing peace for four decades.",
      },
      {
        year: "1813",
        event: "Capture of Attock",
        description:
          "Extended the empire's territory toward Kashmir and the approaches to Afghanistan.",
      },
      {
        year: "1839",
        event: "Death of Ranjit Singh",
        description:
          "His death triggered succession struggles among his heirs that weakened the kingdom he had built.",
      },
      {
        year: "1849",
        event: "Empire annexed after the Anglo-Sikh wars",
        description:
          "The last independent kingdom of the northwest fell to British annexation a decade after its founder's death.",
      },
    ],
    achievements: [
      "Unification of Punjab under a single ruler for the first time in centuries",
      "A modernised Khalsa army equipped with contemporary artillery",
      "A notably plural court and administration",
      "Peaceful coexistence with the British East India Company through treaty diplomacy",
    ],
    legacy:
  ...
  },
  {
    ...
    capital: "Jhansi",
    dynasty: "Newalkar",
    period: "18th century – 1858",
    founded: "18th century",
    region: "Bundelkhand",
    description:
      "A Bundelkhand princely state whose defense in 1857–58 made Rani Lakshmibai a national symbol of resistance.",
    image:
    ...
    timeline: [
      {
        ...
        description:
          "Married into the Newalkar dynasty that ruled the princely state of Jhansi in the Bundelkhand region.",
      },
      {
        year: "1853",
        event: "Gangadhar Rao dies; Lakshmibai governs",
        description:
          "The British East India Company invoked the Doctrine of Lapse to annex Jhansi, refusing to recognise the adopted heir.",
      },
      {
        year: "1857",
        event: "Revolt reaches Bundelkhand",
        description:
          "Rani Lakshmibai took direct command of Jhansi's defence as the uprising against British rule spread across the region.",
      },
      {
        year: "1858",
        event: "Siege of Jhansi and fall of the fort",
        description:
          "British forces under Hugh Rose captured the city; Lakshmibai escaped with her son and continued the resistance until her death near Gwalior.",
      },
    ],
    achievements: [
      "A distinct princely administration in Bundelkhand",
      "One of the most determined regional resistances of the 1857 Revolt",
      "Enduring national memory as a symbol of resistance",
      "Continued commemoration of Rani Lakshmibai's leadership and courage",
    ],
    legacy:
    ...
    timeline: [
      {
        ...
        description:
          "Founded one of the leading houses of the Maratha confederacy, governing the strategically important Malwa region.",
      },
      {
        year: "1767",
        event: "Ahilyabai Holkar assumes direct rule from Maheshwar",
        description:
          "Took charge of the Holkar dynasty's territory after the deaths of her husband, father-in-law, and son, ruling from Maheshwar rather than Indore.",
      },
      {
        year: "1780s",
        event: "Temple and infrastructure patronage across India",
        description:
          "Funded the restoration of major temples, including Kashi Vishwanath and Somnath, along with roads, wells, and dharamshalas nationwide.",
      },
      {
        year: "1795",
        event: "Death of Ahilyabai Holkar",
        description:
          "Closed nearly three decades of celebrated rule; the Holkar dynasty continued to govern Malwa as a leading Maratha state for over a century afterward.",
      },
    ],
    achievements: [
      "Widely regarded as a model of accessible, just administration",
      "Extensive temple restoration and patronage across the Indian subcontinent",
      "Promotion of Maheshwar's handloom weaving and trade",
      "Maintained stability and prosperity in Malwa for decades",
    ],
    legacy:

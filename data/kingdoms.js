...
window.EB_DATA.kingdoms = [
  {
    ...
    "legacy": "The Mauryas proved that a unified imperial order could span the subcontinent — a template later ages never forgot.",
    "references": [
  ...
  },
  {
    ...
    "legacy": "Later generations looked back to the Guptas as a golden age of learning and kingship.",
    "references": [
  ...
  },
  {
    ...
    "achievements": [
      "Deccan imperial identity",
      "Early southern temple architecture",
      "Victory over Harsha"
    ],
    "legacy": "The Chalukyas showed that the Deccan could host an empire equal to the north.",
    "references": [
      "Aihole inscription",
  ...
  },
  {
    ...
    "achievements": [
      "Brihadisvara Temple",
      "Indian Ocean naval reach",
      "Sophisticated village administration"
    ],
    "legacy": "Chola rule remains a high watermark of Tamil statecraft, art, and maritime ambition.",
    "references": [
      "Chola inscriptions",
  ...
  },
  {
    ...
    "achievements": [
      "Rajput control of Delhi and Ajmer",
      "Resistance at Tarain",
      "Lasting place in north Indian memory"
    ],
    "legacy": "The Chauhan kingdom is remembered as the last great Rajput polity of Delhi before the Sultanate age.",
    "references": [
  ...
  },
  {
    ...
    "achievements": [
      "Hampi's urban and temple landscape",
      "Southern imperial unity",
      "Court literature in Telugu and Kannada"
    ],
    "legacy": "Vijayanagara is remembered as a citadel of southern civilization whose ruins still speak of imperial scale.",
    "references": [
  ...
  },
  {
    ...
    "achievements": [
      ...
      "Long resistance to imperial domination",
      "Sisodia royal tradition"
    ],
    "legacy": "Mewar became a byword for Rajput independence and the refusal to surrender sovereignty.",
    "references": [
  ...
  },
  {
    ...
    "achievements": [
      "Centuries of independence in Assam",
      "Paik administrative system",
      "Victory at Saraighat"
    ],
    "legacy": "The Ahoms remain central to Assam's historical identity and the defense of the eastern frontier.",
    "references": [
      "Ahom buranjis"
    ]
  },
  {
    ...
    "achievements": [
      "Swarajya as political ideal",
      "Fort and guerrilla warfare",
      "18th-century pan-Indian expansion"
    ],
    "legacy": "The Maratha Empire reshaped late medieval and early modern India and remains a cornerstone of Deccan historical memory.",
    "references": [
      "Maratha bakhars",
      "Peshwa records"
    ]
  },
  {
    ...
    "achievements": [
      ...
      "Modernized Khalsa army",
      "Plural court and administration"
    ],
    "legacy": "The Sikh Empire is remembered as the last great indigenous kingdom of the northwest before colonial annexation.",
    "references": [
      "Sikh chronicles",
  ...
  },
  {
    ...
    "achievements": [
      "Princely administration in Bundelkhand",
      "1857 resistance",
      "Enduring national memory"
    ],
    "legacy": "Jhansi is inseparable from the story of 1857 and the image of a queen who led from the front.",
    "references": [
      "1857 records",
      "Jhansi state papers"
    ]

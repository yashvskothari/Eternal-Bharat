...
window.EB_DATA.kingdoms = [
  {
    ...
    "forts": [
      {
        "name": "Pataliputra",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The Mauryan capital on the Ganga, described by Megasthenes as a vast fortified city with a timber palisade and moat, and the administrative centre from which Chandragupta and Ashoka governed the empire."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "The Mauryas proved that a unified imperial order could span the subcontinent — a template later ages never forgot. Their administrative innovations influenced Indian statecraft for centuries after the empire's decline around 185 BCE.",
    "references": [
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Pataliputra",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The historic Mauryan capital, continued as a principal Gupta seat and fortified centre from which Samudragupta directed his wide-ranging campaigns of conquest and diplomacy."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "Later generations looked back to the Guptas as a golden age of learning and kingship, a benchmark of classical Indian civilisation whose literary and scientific achievements were remembered for centuries afterward.",
    "references": [
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Badami",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The rock-cut Chalukyan capital (ancient Vatapi), defended by sandstone cliffs above an artificial lake and famed for its 6th- and 7th-century cave temples."
      },
      {
        "name": "Aihole",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "An early workshop of Deccan temple architecture, hosting dozens of experimental Chalukyan shrines that tested the forms later refined at Pattadakal."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "The Chalukyas showed that the Deccan could host an empire equal to the great kingdoms of the north, and their architectural experiments at Aihole and Pattadakal shaped South Indian temple design for centuries.",
    "references": [
      "Aihole inscription",
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Thanjavur",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The Chola capital under Raja Raja I, home to the towering Brihadisvara Temple whose fortified complex proclaimed Chola imperial power across South India."
      },
      {
        "name": "Gangaikonda Cholapuram",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The new capital founded by Rajendra I to commemorate his campaign to the Ganga, featuring a great temple modelled on Thanjavur's and marking the empire's continued expansion."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "Chola rule remains a high watermark of Tamil statecraft, art, and maritime ambition, its temples and bronzes still regarded as among the great achievements of Indian civilisation.",
    "references": [
      "Chola inscriptions",
  ...
  },
  {
    ...
    "overview": "The Chahamanas of Shakambhari rose to prominence around Ajmer and, by Prithviraj III's reign, controlled Delhi as well, positioning them at the very frontier facing invasions from Central Asia. Their defeat at the Second Battle of Tarain in 1192, after an earlier victory the previous year, marked a decisive political turning point that opened the way for the establishment of the Delhi Sultanate in North India.",
    "rulers": [
      "prithviraj-chauhan"
    ],
    "forts": [
      {
        "name": "Ajmer",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The Chahamana capital in central Rajasthan, anchored by the hilltop Taragarh fort from which Prithviraj Chauhan governed before his conflicts with the Ghurids."
      },
      {
        "name": "Qila Rai Pithora",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "Delhi's first major fortified city, built up and named after Prithviraj (Rai Pithora) as the Chahamanas extended their authority over the region."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "The Chauhan kingdom is remembered as the last great Rajput polity of Delhi before the Sultanate age, and its fall is traditionally treated as a watershed moment in medieval Indian history.",
    "references": [
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Hampi",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The fortified capital on the Tungabhadra river, encircled by concentric walls and filled with royal enclosures, temple complexes, and markets that astonished foreign visitors during Krishnadevaraya's reign."
      },
      {
        "name": "Raichur",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "A strategically vital fort in the contested Raichur Doab, repeatedly fought over between Vijayanagara and the Deccan Sultanates, captured by Krishnadevaraya in 1520."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "Vijayanagara is remembered as a citadel of southern civilisation whose ruins at Hampi, now a UNESCO World Heritage Site, still speak to the empire's imperial scale and cosmopolitan wealth.",
    "references": [
  ...
  },
  {
    ...
    "overview": "Mewar, ruled first by the Guhilas and later by the Sisodia branch, made resistance to outside domination a defining political identity across nearly a millennium. From Bappa Rawal's founding of power at Chittorgarh, through Maharana Kumbha's fort-building and Rana Sanga's Rajput confederacy, to Maharana Pratap's long guerrilla resistance and Udai Singh II's founding of Udaipur, Mewar's rulers repeatedly rebuilt their kingdom after defeat rather than accept permanent submission.",
    "rulers": [
      "rana-sanga",
      "maharana-pratap"
    ],
    "forts": [
      {
        "name": "Chittorgarh",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The largest fort complex in India, Mewar's ancient capital and the site of repeated sieges — by Alauddin Khalji in 1303 and by Akbar's forces in 1567–68 — that shaped the kingdom's history."
      },
      {
        "name": "Kumbhalgarh",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "Built by Maharana Kumbha in the 15th century, enclosed by one of the longest continuous fortification walls in the world and used as a secure refuge by later rulers including Maharana Pratap."
      },
      {
        "name": "Chavand",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The modest hill capital established by Maharana Pratap after reclaiming much of Mewar's territory in the 1580s."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "Mewar became a byword for Rajput independence and the refusal to surrender sovereignty, a reputation cemented above all by Maharana Pratap's decades of resistance to Mughal authority.",
    "references": [
    ...
    "forts": [
      {
        "name": "Garhgaon",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "One of the historic Ahom capitals in Upper Assam, fortified with earthen ramparts characteristic of Ahom military architecture adapted to the Brahmaputra valley's terrain."
      },
      {
        "name": "Guwahati river defenses",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The fortified approaches along the Brahmaputra at Guwahati, recaptured and strengthened by Lachit Borphukan, guarding the strategic gateway to the Ahom heartland."
      }
    ],
    "battles": [
      {
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Raigad",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "Shivaji's capital, where he was crowned Chhatrapati in 1674, and which his son Sambhaji continued to hold as the symbolic centre of Maratha swarajya."
      },
      {
        "name": "Pratapgad",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The Sahyadri fort built on Shivaji's orders and the site of his celebrated encounter with the Bijapuri general Afzal Khan in 1659."
      },
      {
        "name": "Sinhagad",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "A strategically vital fort near Pune, the scene of a famous night assault led by Shivaji's general Tanaji Malusare."
      },
      {
        "name": "Rajgad",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "Shivaji's early capital in the Sahyadris, serving as his base during the formative decades of Maratha expansion before the shift to Raigad."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "The Maratha Empire reshaped late medieval and early modern India, and remains a cornerstone of Deccan historical memory — a state built from hill forts into a power that, for a time, eclipsed the Mughals themselves.",
    "references": [
      "Maratha bakhars",
      "Peshwa records"
    ],
  ...
  },
  {
    ...
    "forts": [
      {
        "name": "Lahore Fort",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "The historic citadel that became Ranjit Singh's capital seat after 1799, extensively renovated during his reign as the political heart of the Sikh Empire."
      },
      {
        "name": "Gobindgarh Fort",
        "image": "https://cdn.jsdelivr.net/gh/yashvskothari/Eternal-Bharat-assets@main/assets/images/warriors/chandragupt/portrait.jpg",
        "description": "A key military fortress at Amritsar, refortified under Ranjit Singh to guard the treasury and protect the Sikh Empire's holiest city."
      }
    ],
    "battles": [
      {
    ...
    "legacy": "The Sikh Empire is remembered as the last great indigenous kingdom of the northwest before colonial annexation, admired for the strength and inclusiveness Ranjit Singh built into its institutions.",
    "references": [
      "Sikh chronicles",
  ...
  },
  {
    ...
    "legacy": "Jhansi is inseparable from the story of 1857 and the image of a queen who led from the front, choosing to fight rather than surrender her kingdom.",
    "references": [
      "1857 records",
      "Jhansi state papers"
    ],
  ...
  },
  {
    ...
    "legacy": "The Holkar Kingdom is remembered above all through Ahilyabai's reign — a rare example in Indian history of a ruler celebrated as much for compassion and public works as for military strength. Maheshwar's handloom tradition, which she fostered, continues to this day.",
    "references": [
